...
NPERIOD  = int(1e4)     # heart-beat period
NSTAB    = int(1e4)     # time for blood stablization
NSTEP    = int(4e4)     # time for the whole simulation
NDIAG    = int(1e2)     # time interval between stdout diagnostic messages
NVTKFREQ = int(1e2)     # time interval between vtk outputs
